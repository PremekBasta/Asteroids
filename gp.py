...
def return_individual():
    func = toolbox.compile(expr = "if_then_else(compare(mul(add(mul(mul(add(1, 5), mul(-1, 3)), mul(mul(1, 5), add(ARG1, 5))), mul(add(add(ARG1, ARG1), add(ARG0, ARG1)), add(add(5, ARG2), mul(ARG2, ARG1)))), mul(add(add(add(-1, -1), mul(5, ARG1)), add(add(0, 100), add(3, 5))), add(add(mul(ARG2, 3), add(5, 5)), add(mul(100, 5), add(1, 3))))), mul(add(add(mul(add(ARG1, -1), mul(ARG2, -1)), mul(add(ARG1, 100), mul(ARG1, ARG0))), add(add(add(1, ARG2), add(100, 1)), mul(add(ARG1, ARG2), mul(ARG1, 10)))), add(add(add(add(100, ARG2), add(0, 5)), mul(add(5, 3), mul(100, 10))), mul(add(mul(100, ARG0), mul(-1, ARG0)), add(add(100, 5), add(ARG2, 3)))))), if_then_else(compare(mul(mul(add(mul(ARG1, -1), add(5, 10)), mul(add(0, ARG0), mul(ARG2, -1))), add(add(mul(ARG2, 100), mul(add(mul(-1, ARG1), mul(10, 0)), mul(mul(5, 5), add(ARG2, ARG1)))), add(mul(-1, -1), add(5, 100)))), mul(add(add(add(ARG2, ARG2), add(3, 3)), mul(add(1, 10), mul(3, ARG0))), add(add(add(10, 1), add(ARG0, ARG0)), mul(mul(100, 1), add(100, 5))))), if_then_else(compare(mul(add(add(ARG0, 3), add(1, ARG0)), mul(mul(0, 10), add(5, 3))), mul(mul(mul(0, ARG2), mul(ARG0, 1)), add(add(0, 10), mul(1, 3)))), if_then_else(compare(mul(mul(100, 1), add(1, 10)), add(add(10, 0), add(ARG1, ARG1))), if_then_else(compare(mul(ARG1, ARG1), mul(ARG1, ARG2)), if_then_else(compare(ARG1, -1), if_then_else(False, ret_attack, ret_attack), if_then_else(False, ret_deffense, ret_stop)), if_then_else(compare(mul(ARG1, -1), mul(100, -1)), if_then_else(False, ret_attack, ret_deffense), if_then_else(False, ret_attack, ret_stop))), if_then_else(compare(add(0, ARG2), add(100, 0)), if_then_else(compare(5, ARG0), if_then_else(False, ret_stop, ret_deffense), if_then_else(False, ret_stop, ret_deffense)), if_then_else(compare(ARG0, 5), if_then_else(False, ret_stop, ret_evade), if_then_else(False, ret_deffense, ret_evade)))), if_then_else(compare(mul(add(3, 10), add(100, ARG0)), add(mul(3, 1), add(ARG0, 5))), if_then_else(compare(mul(ARG2, ARG2), mul(0, ARG2)), if_then_else(compare(ARG1, 0), if_then_else(False, ret_evade, ret_stop), if_then_else(False, ret_attack, ret_evade)), if_then_else(compare(100, 3), if_then_else(compare(add(ARG1, 0), mul(100, ARG2)), ret_attack, ret_deffense), if_then_else(False, ret_deffense, ret_stop))), if_then_else(compare(add(ARG2, 10), add(ARG0, ARG1)), if_then_else(compare(10, 0), if_then_else(False, ret_deffense, ret_attack), if_then_else(False, ret_evade, ret_attack)), if_then_else(compare(1, 100), if_then_else(False, ret_stop, ret_evade), if_then_else(False, ret_deffense, ret_stop))))), if_then_else(compare(add(add(add(ARG2, 10), mul(1, 1)), add(mul(ARG2, 5), add(100, 5))), add(mul(add(mul(100, ARG0), ARG0), mul(1, 3)), mul(mul(5, 3), 10))), if_then_else(compare(mul(mul(1, 5), add(0, 3)), mul(mul(0, 1), add(1, 3))), if_then_else(compare(add(ARG0, ARG0), mul(0, 0)), if_then_else(compare(5, -1), if_then_else(False, ret_stop, ret_evade), if_then_else(False, ret_attack, ret_deffense)), if_then_else(compare(0, 0), if_then_else(False, ret_deffense, ret_deffense), if_then_else(False, ret_evade, ret_evade))), if_then_else(compare(mul(100, 3), add(100, 3)), if_then_else(compare(1, 1), if_then_else(False, ret_stop, ret_deffense), if_then_else(False, ret_attack, ret_evade)), if_then_else(compare(100, ARG2), if_then_else(False, ret_evade, ret_deffense), if_then_else(False, ret_evade, ret_evade)))), if_then_else(compare(mul(add(ARG0, 10), add(10, 1)), mul(mul(1, ARG1), mul(ARG0, 1))), if_then_else(compare(mul(ARG1, 0), mul(1, 10)), if_then_else(compare(10, ARG2), if_then_else(False, ret_stop, ret_deffense), if_then_else(False, ret_evade, ret_evade)), if_then_else(compare(100, -1), if_then_else(False, ret_attack, ret_attack), if_then_else(False, ret_stop, ret_attack))), if_then_else(compare(mul(5, ARG2), mul(10, 1)), if_then_else(compare(ARG2, 0), if_then_else(False, ret_stop, ret_stop), if_then_else(False, ret_evade, ret_deffense)), if_then_else(compare(5, 100), if_then_else(False, ret_evade, ret_evade), if_then_else(False, ret_stop, ret_deffense)))))), if_then_else(compare(add(mul(mul(mul(5, ARG2), add(10, ARG1)), mul(add(-1, ARG1), add(ARG1, -1))), add(add(mul(1, 1), mul(ARG2, 100)), add(add(100, 10), mul(5, 1)))), mul(mul(add(mul(ARG1, ARG2), mul(0, 1)), add(add(0, 5), mul(ARG1, ARG0))), add(add(mul(5, 0), mul(1, 3)), mul(mul(ARG2, 5), add(ARG0, 0))))), if_then_else(compare(add(mul(add(ARG2, 10), add(ARG0, 1)), mul(add(100, 100), mul(ARG2, ARG1))), mul(mul(add(ARG1, -1), add(10, -1)), add(mul(1, 5), add(10, 10)))), if_then_else(compare(add(add(0, 10), add(ARG1, 100)), add(mul(ARG2, 100), mul(-1, 1))), if_then_else(compare(add(-1, ARG1), mul(10, ARG2)), if_then_else(compare(5, 0), if_then_else(False, ret_attack, ret_deffense), if_then_else(False, ret_attack, ret_stop)), if_then_else(compare(ARG1, 10), if_then_else(False, ret_evade, ret_attack), if_then_else(False, ret_attack, ret_deffense))), if_then_else(compare(add(ARG1, 0), add(0, 5)), if_then_else(compare(ARG0, -1), if_then_else(False, ret_evade, ret_stop), if_then_else(False, ret_stop, ret_attack)), if_then_else(compare(1, 10), if_then_else(False, ret_deffense, ret_deffense), if_then_else(False, ret_attack, ret_deffense)))), if_then_else(compare(mul(add(1, ARG0), add(ARG0, mul(add(mul(0, 1), mul(100, ARG1)), add(add(5, 1), mul(-1, 100))))), add(add(10, ARG0), add(ARG1, 5))), if_then_else(compare(mul(ARG1, -1), mul(100, -1)), if_then_else(compare(5, ARG2), if_then_else(False, ret_evade, ret_evade), if_then_else(False, ret_deffense, ret_deffense)), if_then_else(compare(3, ARG1), if_then_else(False, ret_evade, ret_evade), if_then_else(False, ret_stop, ret_deffense))), if_then_else(compare(add(3, 1), mul(ARG0, 1)), if_then_else(compare(1, 10), if_then_else(False, ret_evade, ret_evade), if_then_else(False, ret_stop, ret_deffense)), if_then_else(compare(ARG2, 0), if_then_else(False, ret_stop, ret_attack), if_then_else(False, ret_evade, ret_evade))))), if_then_else(compare(add(add(add(100, 3), add(3, ARG1)), mul(add(ARG2, ARG1), mul(100, 1))), mul(mul(mul(10, ARG2), mul(-1, ARG2)), mul(mul(-1, ARG1), add(1, 5)))), if_then_else(compare(mul(mul(1, 100), mul(0, ARG1)), add(mul(1, ARG0), mul(0, ARG0))), if_then_else(compare(mul(5, 0), add(3, 10)), if_then_else(compare(5, 5), if_then_else(False, ret_deffense, ret_evade), if_then_else(False, ret_attack, ret_stop)), if_then_else(compare(ARG0, ARG1), if_then_else(False, ret_evade, ret_attack), if_then_else(False, ret_attack, ret_deffense))), if_then_else(compare(add(ARG2, 10), mul(3, 5)), if_then_else(compare(-1, ARG1), if_then_else(False, ret_evade, ret_stop), if_then_else(compare(mul(ARG0, ARG1), add(100, 0)), ret_evade, ret_stop)), if_then_else(compare(-1, 3), if_then_else(False, ret_attack, ret_evade), if_then_else(False, ret_attack, ret_deffense)))), if_then_else(compare(mul(add(0, 10), mul(-1, 10)), mul(mul(5, 0), mul(100, 5))), if_then_else(compare(mul(ARG0, ARG1), mul(0, 10)), if_then_else(compare(ARG1, ARG1), if_then_else(False, ret_attack, ret_attack), if_then_else(compare(5, 5), if_then_else(False, ret_deffense, ret_evade), if_then_else(False, ret_attack, ret_stop))), if_then_else(compare(ARG1, 10), if_then_else(False, ret_stop, ret_stop), if_then_else(False, ret_evade, ret_evade))), if_then_else(compare(mul(100, -1), add(0, 100)), if_then_else(compare(ARG0, 3), if_then_else(False, ret_deffense, ret_attack), if_then_else(False, ret_attack, ret_deffense)), if_then_else(compare(100, 5), if_then_else(False, ret_attack, ret_deffense), if_then_else(False, ret_deffense, ret_stop)))))))")
    return func
