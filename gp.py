...
pset = gp.PrimitiveSetTyped("main", [int, int, int, int], ActionPlanEnum)
...
if __name__ == "__main__":
    ...
    with open("gp_chaning_best_no_def_auto_write_txt", "+w") as f:
