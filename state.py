from dto import Space_object_DTO
...
class State:
    def __init__(self, neutral_asteroids,
        ...
        for neutral_asteroid in neutral_asteroids:
            self.neutral_asteroids.append(Space_object_DTO(neutral_asteroid.radius, neutral_asteroid.centerx, neutral_asteroid.centery,
        ...
        # Player ONE
        # Rocket ONE
        self.player_one_rocket = Space_object_DTO(player_one_rocket.radius, player_one_rocket.centerx, player_one_rocket.centery,
        ...
        for player_one_asteroid in player_one_asteroids:
            self.player_one_asteroids.append(Space_object_DTO(player_one_asteroid.radius, player_one_asteroid.centerx, player_one_asteroid.centery,
        ...
        for player_one_bullet in player_one_bullets:
            self.player_one_bullets.append(Space_object_DTO(player_one_bullet.radius, player_one_bullet.centerx, player_one_bullet.centery,
        ...
        # Player TWO
        # Rocket TWO
        self.player_two_rocket = Space_object_DTO(player_two_rocket.radius, player_two_rocket.centerx, player_two_rocket.centery,
        ...
        for player_two_asteroid in player_two_asteroids:
            self.player_two_asteroids.append(Space_object_DTO(player_two_asteroid.radius, player_two_asteroid.centerx, player_two_asteroid.centery,
        ...
        for player_two_bullet in player_two_bullets:
            self.player_two_bullets.append(Space_object_DTO(player_two_bullet.radius, player_two_bullet.centerx, player_two_bullet.centery,
