...
\def\Abstrakt{%
Součástí této práce byla implementace mé vlastní, jednoduché, vesmírné hry, 
...
These abstractions help algorithms of aritifical inteligence with game agent manipulation.
