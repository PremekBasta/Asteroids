...
Abychom mohli výsledky experimentů vyhodnocovat, případně je mezi sebou porovnávat, potřebuje mít na výsledky konkrétní kritéria.
...
Druhým naším cílem bude nalézt agenty, kteří se budou chovat zajímavě ve smyslu pestrosti akcí a akčních plánů, nebo také zajímavě v tom smyslu, že bude jejich chování působit jako chování lidského hráče.
...
Průběžným snižování hodnoty $\epsilon$ způsobíme, že z počátku učení se budou zkoušet náhodné akce a v průběhu přjde ze zkoušení nových akcí k prohledávání již osvědčených akcí.
